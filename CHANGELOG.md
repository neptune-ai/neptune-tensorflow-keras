...
- We changed the names of the logging directories from "test" to "validation" to be consistent with the naming
  convention used by Keras ([#26](https://github.com/neptune-ai/neptune-tensorflow-keras/pull/26))
